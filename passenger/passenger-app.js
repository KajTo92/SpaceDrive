...
async function renderTripDetails() {
  ...
  const content = `
    ...
    ${JourneyServiceMedia(ride, { showBookingDetails: true }) || `<section class="detail-map"><div class="live-trip-map" data-live-map data-ride-id="${ride.id}"></div></section>`}
